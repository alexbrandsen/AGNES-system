...
# Lint as: python3
"""Dutch archaeological NER data, Fold 5"""
...
class dutch_archaeo_ner_fold5Config(datasets.BuilderConfig):
    """BuilderConfig for dutch_archaeo_ner_fold5"""
    ...
    def __init__(self, **kwargs):
        ...
        """
        super(dutch_archaeo_ner_fold5Config, self).__init__(**kwargs)


class dutch_archaeo_ner_fold5(datasets.GeneratorBasedBuilder):
    """dutch_archaeo_ner_fold5 dataset."""

    BUILDER_CONFIGS = [
        dutch_archaeo_ner_fold5Config(name="conll2003", version=datasets.Version("1.0.0"), description="dutch_archaeo_ner_fold5 dataset"),
    ]
