...
class dutch_archaeo_nerConfig(datasets.BuilderConfig):
    """BuilderConfig for dutch_archaeo_ner"""
    ...
    def __init__(self, **kwargs):
        ...
        """
        super(dutch_archaeo_nerConfig, self).__init__(**kwargs)


class dutch_archaeo_ner(datasets.GeneratorBasedBuilder):
    """dutch_archaeo_ner dataset."""

    BUILDER_CONFIGS = [
        dutch_archaeo_nerConfig(name="conll2003", version=datasets.Version("1.0.0"), description="dutch_archaeo_ner dataset"),
    ]
