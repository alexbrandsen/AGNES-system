...
# Lint as: python3
"""Dutch archaeological NER data, Fold 2"""
...
class dutch_archaeo_ner_fold2Config(datasets.BuilderConfig):
    """BuilderConfig for dutch_archaeo_ner_fold2"""
    ...
    def __init__(self, **kwargs):
        ...
        """
        super(dutch_archaeo_ner_fold2Config, self).__init__(**kwargs)


class dutch_archaeo_ner_fold2(datasets.GeneratorBasedBuilder):
    """dutch_archaeo_ner_fold2 dataset."""

    BUILDER_CONFIGS = [
        dutch_archaeo_ner_fold2Config(name="conll2003", version=datasets.Version("1.0.0"), description="dutch_archaeo_ner_fold2 dataset"),
    ]
