...
# Lint as: python3
"""Dutch archaeological NER data, Fold 1"""
...
class dutch_archaeo_ner_fold1Config(datasets.BuilderConfig):
    """BuilderConfig for dutch_archaeo_ner_fold1"""
    ...
    def __init__(self, **kwargs):
        ...
        """
        super(dutch_archaeo_ner_fold1Config, self).__init__(**kwargs)


class dutch_archaeo_ner_fold1(datasets.GeneratorBasedBuilder):
    """dutch_archaeo_ner_fold1 dataset."""

    BUILDER_CONFIGS = [
        dutch_archaeo_ner_fold1Config(name="conll2003", version=datasets.Version("1.0.0"), description="dutch_archaeo_ner_fold1 dataset"),
    ]
